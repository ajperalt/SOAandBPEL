...
%Einrückung im Absatz entfernen
\parindent 0pt
...
\begin{titlepage} 
\author{Oliver Stannarius \\ und \\Roman Müller} 
...
%\begin{figure}[htbp]
 % \centering
  ...
  %\caption[Titel für das Verzeichnis]{Titel}
  %\label{Labelname}
%\end{figure}
\newpage
...
Eine genaue Definition für SOA gibt es nicht. Die ersten die den Begriff
verwendeten war die Gartner Group und diese definieren SOA wie folgt: \\ 
